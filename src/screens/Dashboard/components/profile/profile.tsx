...
// import './profile.css';
// import { StoredUser } from '../Hook/StoredUser';
...
//   const getProfessionName = (profession: number): string => {
//     switch (profession) {
//       case 0:
//         return 'Ninguna';
//       case 1:
...
//             <span className="profile-label">Usuario:</span> {storedUser.userName}
//           </div>
//           <div className="profile-item">
//             <span className="profile-label">Nombre Completo:</span> {storedUser.firstName} {storedUser.lastName}
//           </div>
//           <div className="profile-item">
//             <span className="profile-label">Rol:</span> {storedUser.role}
//           </div>
//           <div className="profile-item">
//             <span className="profile-label">Email:</span> {storedUser.email}
//           </div>
//           <div className="profile-item">
//             <span className="profile-label">Profesión:</span> {getProfessionName(storedUser.profession)}
//           </div>
//         </div>
//       )}
//       <button
